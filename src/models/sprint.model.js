...
const pastSprint = new Schema({
    ...
    progress:       { type: Number, required: true, trim: true },
    description:    { type: String, required: true, trim: true },
    notify :        { type: Boolean },
    user:           { type: String, required: true, trim: true },
    createdAt:      { type: Date, defaul: Date.now, required: true, trim: true },
    startedAt:      { type: Date, defaul: Date.now, required: true, trim: true },
    finishedAt:     { type: Date, defaul: Date.now, required: true, trim: true }
});
